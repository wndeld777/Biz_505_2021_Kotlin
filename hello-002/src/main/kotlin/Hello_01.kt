...
fun main() {
     ...
     * type 을 지정하여 변수를 선언하는 것이 익숙하지 않아서
     * 많은 어려움을 겪는다
     *
     * Kotlin 에서는 변수를 선언할 때 어떤 값을 저장할지 결정이되면
     ...
     */
    // 정수 0 을 사용하여 초기화 하였으므로 정수형 변수가 된다
    var num1 = 0
    ...
    // var str2 = null
    // 정말 null 을 처리하고 싶은 경우 safe null 이라는 형식을 사용
    // 1. 표준문문법으로 변수를 선언하다 : type 을 강제 지정하여 선언
    // 2. type 키워드 뒤에 ?(safe null) 기호를 첨가
