 ...
 *      변수:타입? = null 처럼 null 로 초기화된 변수를 선언한다
 */
fun main() {
    ...
    // intNum1을 Int 형으로 선언하고 null 을 제한적으로 허용
    /**
     * 3항 연산 try
     * Integer.valueOf(num1) 실행이 정상적으로 종료되면
     *      연산 결과가 intNum1 에 담기고
     * Exception 이 발생하면
     *      println() 이 실행되고 메시지를 출력한 후
     *      null 값이 intNum1 에 담기게 된다다     */
    var intNum1:Int? = try {
        Integer.valueOf(num1) // return 이 있는것처럼 행동
    ...
    try{
        ...
        println("숫자 1은 정수형만 입력하세요 입력한 숫자 : $num2")
    }
